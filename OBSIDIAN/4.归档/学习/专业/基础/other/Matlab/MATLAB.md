...
![[MATLAB.imgs/image-20210322161050827.png]]
参数方程的绘制：
$$
\begin{cases} 
x = tcos(3t)\\
...
![[MATLAB.imgs/image-20210322161309782.png]]
调制波形的绘制
...
![[MATLAB.imgs/image-20210322161928024.png]]
...
![[MATLAB.imgs/image-20210322163505937.png]]
...
![[MATLAB.imgs/image-20210322164456442.png]]
...
![[MATLAB.imgs/image-20210322165902728.png]]
...
![[MATLAB.imgs/image-20210322171403108.png]]
（图中的点为ts）
...
![[MATLAB.imgs/image-20210324201735451.png]]
...
![[MATLAB.imgs/image-20210330110315924.png]]
**例题2**
$$
求方程 ax^2+bx+c=0的根
$$
...
![[MATLAB.imgs/image-20210330102725081.png]]
**例题3**
$$
计算分段函数 
\begin{cases} 
...
![[MATLAB.imgs/image-20210330103408934.png]]
**例题4**
...
![[MATLAB.imgs/image-20210330103718784.png]]
**例题5**
...
![[MATLAB.imgs/image-20210330104519216.png]]
**例题6**
...
![[MATLAB.imgs/image-20210330104654187.png]]
**例题7**
$$
...
![[MATLAB.imgs/image-20210330105535098.png]]
**例题8**
...
![[MATLAB.imgs/image-20210330105856563.png]]
**例题9**
...
![[MATLAB.imgs/image-20210330110004611.png]]
...
![[MATLAB.imgs/image-20210405160624369.png]]
**例题11**
...
![[MATLAB.imgs/image-20210412160318955.png]]
...
![[MATLAB.imgs/image-20210412160553945.png]]
**多项式乘法`conv()`**
...
![[MATLAB.imgs/image-20210412160841520.png]]
**多项式加法：`直接加，不够的补上 0 `**
...
![[MATLAB.imgs/image-20210412161044941.png]]
**实现任意长度多项式相加函数：**
...
![[MATLAB.imgs/image-20210412161739535.png]]
...
![[MATLAB.imgs/image-20210412162053853.png]]
**多项式的导数 `polyder()`**
...
![[MATLAB.imgs/image-20210412162643883.png]]
**多项式的估值`polyval()`**
$$
...
![[MATLAB.imgs/image-20210412163046190.png]]
...
![[MATLAB.imgs/image-20210412165007007.png]]
...
![[MATLAB.imgs/image-20210412165740650.png]]
### 数值定积分
...
![[MATLAB.imgs/image-20210412171051058.png]]
...
![[MATLAB.imgs/image-20210412170900672.png]]
...
![[MATLAB.imgs/image-20210412172032704.png]]
### 数据插值
...
![[MATLAB.imgs/image-20210419155643963.png]]
...
![[MATLAB.imgs/image-20210419160450112.png]]
...
![[MATLAB.imgs/image-20210419162140048.png]]
因式分解
...
![[MATLAB.imgs/image-20210419162307004.png]]
化简 `simplify`  `simple`
...
![[MATLAB.imgs/image-20210419164349946.png]]
...
![[MATLAB.imgs/image-20210419165716570.png]]
...
![[MATLAB.imgs/image-20210419170704038.png]]
### 符号积分
...
![[MATLAB.imgs/image-20210419171018559.png]]
### 符号代数方程的求解
...
![[MATLAB.imgs/image-20210308162050858.png]]
